...
/**
 * An activity representing a single History detail screen. This activity is
 * only used on handset devices. On tablet-size devices, item details are
 * presented side-by-side with a list of items in a {@link HistoryListActivity}.
 * <p>
 * This activity is mostly just a 'shell' activity containing nothing more than
 * a {@link HistoryDetailFragment}.
 */
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			getSupportFragmentManager().beginTransaction()
					.add(R.id.history_detail_container, fragment).commit();
		}
	}
